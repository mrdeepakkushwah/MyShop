...
const Signup = () => {
    ...
    const submitHandler = async (e) => {
        ...
        if (!validateEmail(email)) {
            toast.error("Enter a valid email address.", { position: "top-right", autoClose: 3000 });
            setLoading(false);
            return;
        }
        ...
        try {
            ...
            if (response.data.message === "User Signup Successfully") {
                ...
                toast.error(response?.data?.message || "Signup failed.", { position: "top-right", autoClose: 3000 });
            }
        } catch (error) {
        ...
        <>
            ...
            <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
                <div className="bg-white shadow-md rounded-lg p-8 w-full max-w-md">
                    <h2 className="text-2xl font-bold mb-6 text-center text-gray-800">Signup Account</h2>
                    <form onSubmit={submitHandler} className="space-y-4">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className={`w-full py-2 px-4 text-white font-semibold rounded-md ${loading ? "bg-blue-300 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-700"}`}
                        >
